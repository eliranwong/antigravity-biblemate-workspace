...
The python orchestrator script is located at `.claude/skills/biblemate/biblemate_orchestrator.py`. Use it for file management operations:
...
Leverage the personas defined in `.claude/agents.md` for different phases. Each persona brings distinct expertise:
