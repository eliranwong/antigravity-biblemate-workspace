...
- Always run the python script located at `.grok/skills/names/names_query.py` to search the local name definitions database.
- Execute the script using: `python3 .grok/skills/names/names_query.py "<query>"` where `<query>` is the name or search terms.
