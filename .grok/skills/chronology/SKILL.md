...
- Always run the python script located at `.grok/skills/chronology/chronology_query.py` to search the local timeline databases.
- Execute the script using: `python3 .grok/skills/chronology/chronology_query.py "<query>"` where `<query>` is the input prompt, a specific year, name, or event.
