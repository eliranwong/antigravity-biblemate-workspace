...
- Always run the python retriever script located at `.grok/skills/lexicon/lexicon_retriever.py` to retrieve the requested entries.
- Execute the script using: `python3 .grok/skills/lexicon/lexicon_retriever.py "<query>"` where `<query>` is the input prompt or arguments.
