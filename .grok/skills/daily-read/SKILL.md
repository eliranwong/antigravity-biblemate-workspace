...
- Run the python retriever script located at `.grok/skills/daily-read/daily_reader.py` to retrieve the readings and scripture texts.
- Execute the script using: `python3 .grok/skills/daily-read/daily_reader.py "[arguments]"` where `[arguments]` can include a date string, a day number (1-365), and/or bible versions (e.g. `NET`).
