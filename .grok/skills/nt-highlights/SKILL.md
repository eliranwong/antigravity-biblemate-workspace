---
name: nt-highlights
description: Outline key highlights, major events, and summaries for a New Testament passage. Use when the user runs /nt-highlights or requests this BibleMate workflow.
---
