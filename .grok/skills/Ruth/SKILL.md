...
- Always run the python retriever script located at `.grok/skills/search/search_retriever.py` with the `--book Ruth` option to perform the search.
- Execute the script using: `python3 .grok/skills/search/search_retriever.py --book Ruth "<query>"` where `<query>` is the input prompt or arguments.
