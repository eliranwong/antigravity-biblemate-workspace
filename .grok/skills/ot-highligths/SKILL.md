---
name: ot-highligths
description: Outline key highlights, major events, and summaries for an Old Testament passage. Use when the user runs /ot-highligths or requests this BibleMate workflow.
---
