---
name: bible
description: Retrieve bible verses from the local SQLite databases based on versions and references. Use when the user runs /bible or requests this BibleMate workflow.
---
...
- Always run the python retriever script located at `.grok/skills/bible/bible_retriever.py` to retrieve the requested verses.
- Execute the script using: `python3 .grok/skills/bible/bible_retriever.py "<query>"` where `<query>` is the input prompt or arguments.
