---
name: themes
description: Study doctrinal, theological, and spiritual themes in a passage. Use when the user runs /themes or requests this BibleMate workflow.
---

# Themes Skill

## Overview
This standalone skill enables any agent to perform a high-quality themes study for a given Bible reference, text, or topic.
