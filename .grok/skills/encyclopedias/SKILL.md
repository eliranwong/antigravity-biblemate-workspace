...
- Always run the python retriever script located at `.grok/skills/encyclopedias/encyclopedias_query.py` to retrieve encyclopedia records.
- Execute the script using: `python3 .grok/skills/encyclopedias/encyclopedias_query.py "<query>"` where `<query>` is the encyclopedia entry to search.
