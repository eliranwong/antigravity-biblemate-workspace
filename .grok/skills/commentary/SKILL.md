...
- Always run the python retriever script located at `.grok/skills/commentary/commentary_retriever.py` to retrieve the requested commentaries.
- Execute the script using: `python3 .grok/skills/commentary/commentary_retriever.py "<query>"` where `<query>` is the input prompt or arguments.
