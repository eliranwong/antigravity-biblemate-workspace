...
- Always run the python retriever script located at `.grok/skills/promises/promises_query.py` to retrieve the database promise records.
- Execute the script using: `python3 .grok/skills/promises/promises_query.py "<query>"` where `<query>` is the name or category of the promise.
