...
Adopt the **OT Bible Scholar** (for Old Testament periods), **NT Bible Scholar** (for New Testament periods), or **Biblical Theologian** persona from `.grok/agents.md` depending on the context of the query.
