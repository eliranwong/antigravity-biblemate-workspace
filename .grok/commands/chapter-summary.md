...
Adopt the **OT Bible Scholar** (for Old Testament chapters) or **NT Bible Scholar** (for New Testament chapters) persona from `.grok/agents.md`.

Use the **chapter-summary** skill to retrieve baseline chapter summary data.

Always execute:
`python3 .grok/skills/chapter-summary/chapter_summary_retriever.py "$1 $2 $3 $4 $5"`
